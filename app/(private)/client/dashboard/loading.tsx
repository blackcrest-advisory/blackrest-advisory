  ...
  return (
    <div className="relative">
      ...
      <section className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
        ...
        <div className="relative z-10 grid gap-8 px-5 py-7 sm:px-6 sm:py-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-stretch lg:px-8 lg:py-8 xl:grid-cols-[minmax(0,1fr)_360px] xl:px-9">
          {/* left */}
          <div className="flex flex-col justify-between">
            <div>
              ...
              <Skeleton className="mt-6 h-10 w-[80%] max-w-xl sm:h-12"/>
      ...
      <section className="relative mt-6 overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
        ...
        {/* header */}
        <div className="grid gap-6 border-b border-border px-5 py-6 sm:px-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end xl:px-7">
          <div>
            <div className="flex items-center gap-2">
              <Skeleton className="h-3.5 w-3.5" />
              <Skeleton className="h-2.5 w-28" />
        ...
        {/* summary */}
        <div className="grid border-b border-border bg-muted/10 sm:grid-cols-3">
          {Array.from({ length: 3 }).map((_, index) => (
            <div
              key={index}
              className={`
        ...
        {/* chart */}
        <div className="px-5 pb-5 pt-5 sm:px-6 lg:px-7">
          <div className="relative h-[270px] overflow-hidden sm:h-[310px] lg:h-[350px]">
            {/* chart grid */}
            ...
            <div className="absolute inset-x-4 bottom-8 top-8">
              <div className="absolute bottom-[18%] left-[2%] h-[2px] w-[18%] origin-left -rotate-[10deg] bg-muted"/>

              <div className="absolute bottom-[32%] left-[19%] h-[2px] w-[18%] origin-left rotate-[8deg] bg-muted"/>

              <div className="absolute bottom-[25%] left-[36%] h-[2px] w-[20%] origin-left -rotate-[15deg] bg-muted"/>

              <div className="absolute bottom-[44%] left-[54%] h-[2px] w-[20%] origin-left -rotate-[9deg] bg-muted"/>

              <div className="absolute bottom-[57%] left-[72%] h-[2px] w-[24%] origin-left -rotate-[5deg] bg-muted"/>
            </div>
        ...
        {/* footer */}
        <div className="flex flex-col gap-3 border-t border-border bg-muted/15 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
      ...
      <section className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.6fr)_minmax(300px,0.4fr)]">
        {/* active projects */}
        <div className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
          ...
          <div className="flex flex-col gap-2 border-t border-border bg-muted/15 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
      ...
      <section className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-[minmax(280px,0.38fr)_minmax(0,1.62fr)]">
        {/* quick actions */}
        <div className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
          <div className="absolute left-0 top-0 h-[2px] w-full bg-gradient-to-r from-secondary/40 via-secondary/20 to-transparent"/>
        ...
        <div className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
          ...
          <div className="flex items-center justify-between border-t border-border bg-muted/15 px-5 py-4 sm:px-6">
            <Skeleton className="h-2.5 w-36" />
            <Skeleton className="h-3 w-32" />
          </div>
        </div>
      ...
      <section className="relative mt-6 overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
        ...
        <div className="grid gap-6 px-5 py-6 sm:px-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center lg:px-7 lg:py-7 xl:px-8">
          {/* account manager */}
