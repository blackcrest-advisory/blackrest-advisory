      ...
      <div className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
        ...
        <div className="flex flex-col gap-5 border-b border-border px-4 pb-4 pt-5 sm:px-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex w-full flex-col gap-3 lg:w-auto lg:flex-row lg:items-center">
            ...
            <Skeleton className="h-10 w-full lg:w-[170px]" />
                ...
                >
                  ...
                  <td className="px-5 py-4">
                    <div className="flex items-center justify-end gap-2">
                      <Skeleton className="h-8 w-8 border border-border" />
                      <Skeleton className="h-8 w-8 border border-border" />
                    </div>
                  </td>
                </tr>
          ...
          {Array.from({ length: 4 }).map((_, index) => (
            <article key={index} className="p-4 sm:p-5">
              ...
              <div className="mt-4 flex items-center gap-2">
                <Skeleton className="h-[38px] flex-1 border border-border" />
                <Skeleton className="h-[38px] w-[38px] border border-border" />
              </div>
            </article>
          ))}
        </div>
