  ...
  return (
    <div className="relative space-y-6">
      ...
      <section className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
        ...
        <div className="relative z-10 grid gap-8 px-5 py-7 sm:px-6 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-end lg:px-8 lg:py-8">
          {/* left */}
          <div>
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="max-w-[170px] truncate font-mono text-[8px] uppercase tracking-[0.13em] text-muted-foreground/40">
                #{brief.id}
              </span>
            </div>

            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
              <h1 className="min-w-0 text-3xl font-semibold leading-[1.08] tracking-[-0.045em] text-heading sm:text-4xl">
                {brief.title}
              </h1>
      ...
      {hasProposal ? (
        <section className="relative overflow-hidden border border-secondary/20 bg-card shadow-[var(--shadow-card)]">
          ...
          <div className="absolute left-0 top-0 h-[2px] w-full bg-gradient-to-r from-secondary via-secondary/50 to-transparent"/>
          ...
          <div className="relative z-10 flex flex-col gap-4 border-b border-border px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div>
              ...
              <h2 className="mt-2 text-xl font-semibold tracking-[-0.025em] text-heading">
                Proposal
              </h2>
          ...
          {/* proposal summary */}
          <div className="relative z-10 grid grid-cols-1 border-b border-border bg-muted/10 sm:grid-cols-2 lg:grid-cols-3">
            <div className="px-5 py-4 sm:px-6">
              <p className="font-mono text-[7px] uppercase tracking-[0.15em] text-muted-foreground/40">
                Timeline
              </p>

              <p className="mt-2 whitespace-pre-wrap text-sm font-medium text-heading">
            ...
            <div className="border-t border-border px-5 py-4 sm:col-span-2 lg:col-span-1 lg:border-l lg:border-t-0 lg:px-6">
              <p className="font-mono text-[7px] uppercase tracking-[0.15em] text-muted-foreground/40">
                Proposal status
              </p>
          ...
          <div className="relative z-10 grid gap-0 lg:grid-cols-2">
            <div className="border-b border-border px-5 py-6 sm:px-6 lg:border-b-0 lg:border-r">
          ...
          {brief.proposal!.terms && (
            <div className="relative z-10 border-t border-border px-5 py-6 sm:px-6">
              <p className="font-mono text-[8px] font-semibold uppercase tracking-[0.17em] text-secondary">
                Terms
              </p>
          ...
          {/* actions */}
          <div className="relative z-10 border-t border-border bg-muted/15 px-5 py-5 sm:px-6">
        ...
        <div className="space-y-6">
          ...
          {brief.referenceLinks && (
            <section className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
              ...
              <div className="break-words whitespace-pre-wrap px-5 py-6 text-sm leading-7 text-muted-foreground sm:px-6">
                {brief.referenceLinks}
              </div>
            </section>
          )}
          ...
          {brief.attachments.length > 0 && (
            <section className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
              ...
              <div className="flex items-center justify-between gap-4 border-b border-border px-5 py-5 sm:px-6">
                ...
                <div className="border border-border bg-background/60 px-3 py-2 font-mono text-[8px] font-semibold text-heading">
              ...
              <div className="divide-y divide-border">
                {brief.attachments.map((attachment, index) => (
                  ...
                  >
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center border border-secondary/15 bg-secondary/[0.05] text-secondary">
                      <Paperclip className="h-4 w-4" />
                    </div>

                    <div className="min-w-0 flex-1">
                      <p className="font-mono text-[7px] uppercase tracking-[0.15em] text-muted-foreground/35">
                    ...
                    <ArrowUpRight className="h-4 w-4 shrink-0 text-muted-foreground/35 transition-all duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-secondary"/>
                  </div>
                ))}
              </div>
            </section>
            ...
            <div className="divide-y divide-border">
              <div className="flex items-start gap-3 px-5 py-4 sm:px-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-medium capitalize text-heading">
                    {brief.pillar.replace(/_/g, " ")}
                  </p>
                </div>
              </div>
