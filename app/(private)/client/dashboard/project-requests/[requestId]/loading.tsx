  ...
  return (
    <div className="relative space-y-6">
        ...
        <div className="relative z-10 grid gap-8 px-5 py-7 sm:px-6 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-end lg:px-8 lg:py-8">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Skeleton className="h-9 w-[75%] max-w-lg sm:h-10"/>
      ...
      <section className="relative overflow-hidden border border-secondary/20 bg-card shadow-[var(--shadow-card)]">
        ...
        {/* summary */}
        <div className="grid grid-cols-1 border-b border-border bg-muted/10 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {/* actions */}
        <div className="border-t border-border bg-muted/15 px-5 py-5 sm:px-6">
