  ...
  return (
    <div className="relative space-y-6">
      ...
      <div>
        ...
        >
          <span
            className="flex h-7 w-7 items-center justify-center rounded-md border border-border bg-card transition-colors group-hover:border-secondary/30 group-hover:bg-secondary/[0.04] group-hover:text-secondary"
          >
      ...
      >
        ...
        >
          ...
          <div className="min-w-0">
            ...
            >
              <h1
                className="min-w-0 break-words text-2xl font-semibold tracking-[-0.04em] text-heading sm:text-3xl lg:text-[34px]"
              >
                {brief.title}
              </h1>
        ...
        <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2
                    className="mt-0.5 text-base font-semibold text-heading"
                  >
                    Project Summary
                  </h2>
                </div>
              ...
              <span
                className="hidden font-mono text-[7px] uppercase tracking-[0.14em] text-muted-foreground/30 sm:block"
              >
                Request context
              </span>
            </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  className="flex h-9 w-9 items-center justify-center rounded-md border border-border bg-muted/20 text-muted-foreground"
                >
            ...
            {brief.attachments.length > 0 ? (
              <div className="divide-y divide-border">
                {brief.attachments.map((attachment, index) => (
                  ...
                  >
                    <div
                      className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-border bg-background text-muted-foreground transition-colors group-hover:border-secondary/20 group-hover:text-secondary"
                    >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p
                        className="mt-1 font-mono text-[7px] uppercase tracking-[0.14em] text-muted-foreground/35"
                      >
                    ...
                    <span
                      className="shrink-0 font-mono text-[7px] uppercase tracking-[0.12em] text-secondary"
                    >
                      Open
                    </span>
                  </div>
              ...
              <div
                className="flex min-h-32 flex-col items-center justify-center px-5 py-8 text-center sm:px-6"
              >
                <div
                  className="flex h-9 w-9 items-center justify-center rounded-md border border-border bg-muted/15 text-muted-foreground"
                >
                  <Paperclip className="h-4 w-4" />
                </div>
          ...
          >
            ...
            <div className="px-5 py-5">
              ...
              >
                ...
                <span
                  className="max-w-[160px] truncate font-mono text-[8px] text-heading"
                >
                  {brief.user.id}
                </span>
              </div>
