  ...
  return (
    <div className="relative">
      ...
      <section className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
        ...
        <div className="relative z-10 grid gap-8 px-5 py-7 sm:px-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-stretch lg:px-8 lg:py-8">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              {/* welcome heading */}
              <Skeleton className="mt-6 h-10 w-[78%] max-w-xl sm:h-12"/>
        ...
        <div className="relative z-10 grid border-t border-border bg-muted/15 sm:grid-cols-3">
          {Array.from({ length: 3 }).map((_, index) => (
            <div
              key={index}
              className={`
      ...
      <section className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5">
      ...
      <section className="relative mt-6 overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
        ...
        {/* header */}
        <div className="grid gap-6 border-b border-border px-5 py-5 sm:px-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
          <div>
            <div className="flex items-center gap-2">
        ...
        <div className="px-5 py-6 sm:px-6">
          <div className="relative h-[280px] overflow-hidden sm:h-[320px] lg:h-[350px]">
            ...
            <div className="absolute inset-x-5 bottom-8 top-8">
              <div className="absolute bottom-[20%] left-[2%] h-[2px] w-[18%] -rotate-[12deg] bg-muted"/>

              <div className="absolute bottom-[35%] left-[19%] h-[2px] w-[19%] rotate-[7deg] bg-muted"/>

              <div className="absolute bottom-[29%] left-[36%] h-[2px] w-[22%] -rotate-[13deg] bg-muted"/>

              <div className="absolute bottom-[48%] left-[56%] h-[2px] w-[20%] -rotate-[8deg] bg-muted"/>

              <div className="absolute bottom-[61%] left-[74%] h-[2px] w-[22%] -rotate-[5deg] bg-muted"/>
            </div>
      ...
      <section className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.65fr)_minmax(300px,0.35fr)]">
        {/*===== ACTIVE PROJECTS =====*/}
        ...
        <div className="relative overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-[minmax(180px,1.4fr)_100px_110px_160px_80px] gap-4 border-b border-border bg-muted/20 px-6 py-3">
              {Array.from({ length: 5 }).map((_, index) => (
                <Skeleton
                  key={index}
                  className={`
