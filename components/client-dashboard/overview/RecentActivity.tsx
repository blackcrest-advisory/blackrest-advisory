          ...
          <ul className="divide-y divide-border">
            {activities.map((item, idx) => (
              <motion.li
                ...
                className="group/activity relative px-5 py-4 transition-colors duration-200 hover:bg-secondary/[0.02] sm:px-6"
              >
                {/* left hover signal */}
                <span className="absolute bottom-0 left-0 top-0 w-[2px] bg-secondary opacity-0 transition-opacity duration-300 group-hover/activity:opacity-100"/>
