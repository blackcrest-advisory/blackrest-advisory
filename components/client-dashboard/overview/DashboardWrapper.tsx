  ...
  return (
    <div className="relative">
        ...
        <div className="relative z-10 grid gap-8 px-5 py-7 sm:px-6 sm:py-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-stretch lg:px-8 lg:py-8 xl:grid-cols-[minmax(0,1fr)_360px] xl:px-9">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              {/* heading */}
              <h1 className="mt-5 max-w-3xl text-3xl font-semibold leading-[1.05] tracking-[-0.045em] text-heading sm:text-4xl xl:text-[2.8rem]">
                Welcome back,
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-lg font-semibold tracking-[-0.025em] text-heading">
                    Everything in one place
                  </p>
                </div>

                <span className="font-mono text-[8px] uppercase tracking-[0.14em] text-muted-foreground/35">
                  BCR / CLIENT
                </span>
              </div>
      ...
      >
        ...
        {/* projects + milestones */}
        <section className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.6fr)_minmax(300px,0.4fr)]">
