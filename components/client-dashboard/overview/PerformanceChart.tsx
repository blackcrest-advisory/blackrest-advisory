    ...
    >
      ...
      <div className="relative z-10 grid gap-6 border-b border-border px-5 py-6 sm:px-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end xl:px-7">
        ...
        <div>
          ...
          <h2 className="mt-3 text-xl font-semibold tracking-[-0.03em] text-heading sm:text-2xl">
        ...
        <div className="flex items-center gap-2 self-start border border-border bg-background/60 px-3 py-2 lg:self-auto">
          <span className="font-mono text-[8px] font-semibold uppercase tracking-[0.15em] text-muted-foreground/45">
            Period
          </span>
      ...
      <div className="relative z-10 grid border-b border-border bg-muted/10 sm:grid-cols-3">
        <div className="px-5 py-4 sm:px-6">
          <p className="font-mono text-[7px] uppercase tracking-[0.16em] text-muted-foreground/40">
            Leads generated
          </p>

          <div className="mt-1.5 flex items-baseline gap-2">
            <span className="text-xl font-semibold tracking-[-0.035em] text-heading">
              {latestLeads}
            </span>
        ...
        <div className="border-t border-border px-5 py-4 sm:border-l sm:border-t-0 sm:px-6">
          ...
          <p className="mt-1.5 text-xl font-semibold tracking-[-0.035em] text-heading">
            {latestConversions}
          </p>
        </div>
      ...
      <div className="relative z-10 flex flex-wrap items-center gap-x-6 gap-y-2 px-5 pt-5 sm:px-6 xl:px-7">
        ...
        <div className="flex items-center gap-2">
          <span className="h-2 w-2 rounded-full bg-primary dark:bg-[#8ea7c5]"/>
