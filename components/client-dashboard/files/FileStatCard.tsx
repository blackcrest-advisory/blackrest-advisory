...
export const FileStatCard = ({
  ...
  return (
    <div className="group relative h-full min-w-0 px-5 py-5 transition-colors hover:bg-secondary/[0.018] sm:px-6">
      {/*===== METRIC =====*/}

      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <p className="font-mono text-[7px] font-semibold uppercase tracking-[0.14em] text-muted-foreground/45">
            {label}
          </p>
        ...
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-secondary/15 bg-secondary/[0.045] text-secondary transition-colors group-hover:border-secondary/25 group-hover:bg-secondary/[0.07]">
