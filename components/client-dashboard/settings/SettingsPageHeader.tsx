...
export const SettingsPageHeader = () => {
  return (
    <header className="relative min-w-0 overflow-hidden border border-border bg-card shadow-[var(--shadow-card)]">
      ...
      <div className="relative z-10 px-6 py-7 sm:px-7 lg:px-9 lg:py-9">
        <div className="max-w-3xl">
          <div className="flex flex-wrap items-center gap-3">
            <span className="flex h-7 w-7 items-center justify-center rounded-md border border-secondary/15 bg-secondary/[0.05] text-secondary">
          ...
          <h1 className="mt-6 text-3xl font-semibold tracking-[-0.05em] text-heading sm:text-[40px] lg:text-[46px]">
            Your account,
      ...
      <div className="relative z-10 grid border-t border-border bg-background/20 sm:grid-cols-3">
        <AccountArea
          icon={UserRound}
          label="Profile"
      ...
      <div className="relative z-10 flex flex-col gap-2 border-t border-border bg-muted/10 px-6 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-7 lg:px-9">
        ...
        <span className="font-mono text-[7px] uppercase tracking-[0.12em] text-muted-foreground/35">
          Account preferences
        </span>
      </div>
    </header>
...
function AccountArea({
  ...
  return (
    <div className="group flex items-start gap-3 border-b border-border px-6 py-4 transition-colors hover:bg-secondary/[0.018] sm:border-b-0 sm:border-r sm:last:border-r-0 lg:px-9">
      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md border border-border bg-card text-secondary transition-colors group-hover:border-secondary/20 group-hover:bg-secondary/[0.04]">
