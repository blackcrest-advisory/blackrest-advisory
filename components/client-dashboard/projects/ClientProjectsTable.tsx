...
export function ClientProjectsTable({ projects }: ClientProjectsTableProps) {
  if (projects.length === 0) {
    return (
      <div className="relative overflow-hidden border border-border bg-card px-6 py-16 text-center shadow-[var(--shadow-card)]">
        <div
          aria-hidden="true"
                ...
                >
                  ...
                  <TableCell>
                    <div className="flex min-w-[150px] items-center gap-3">
                      ...
                      <span className="w-9 text-right font-mono text-[9px] font-medium text-foreground/70">
                        {progress}%
                      </span>
                    </div>
                  </TableCell>
            ...
            >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 font-mono text-[8px] uppercase tracking-[0.1em] text-muted-foreground/35">
                        #{project.id.slice(-8)}
                      </p>
                    </div>
              ...
              <div className="mt-5">
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <span className="font-mono text-[9px] font-semibold text-heading">
                    {progress}%
                  </span>
                </div>
