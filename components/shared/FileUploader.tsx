    ...
    <div className="space-y-3">
      ...
      {!selectedFile && (
        <button
          ...
          disabled={isUploading}
          className="group relative w-full overflow-hidden border border-dashed border-border bg-background/20 px-4 py-5 text-left transition-colors hover:border-secondary/30 hover:bg-secondary/[0.025] disabled:cursor-not-allowed disabled:opacity-60"
        >
          {/* top signal */}
          <div
            aria-hidden="true"
        ...
        <div className="relative overflow-hidden border border-border bg-background/25">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p
                    className="mt-1 truncate text-sm font-semibold text-heading"
                ...
                <button
                  ...
                  className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-muted/40 hover:text-heading disabled:cursor-not-allowed disabled:opacity-50"
                >
          ...
          <div className="flex flex-col-reverse gap-2 border-t border-border bg-muted/10 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
            <button
              ...
              onClick={openFilePicker}
              disabled={isUploading}
              className="text-left text-[11px] font-medium text-muted-foreground transition-colors hover:text-secondary disabled:cursor-not-allowed disabled:opacity-50"
            >
              Choose another file
            </button>
