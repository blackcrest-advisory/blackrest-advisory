...
export default function SidebarFooter({
  ...
  return (
    ...
    >
      {/* Account identity */}
      <div className="relative overflow-hidden border border-border bg-background/70 p-3 shadow-[var(--shadow-card)]">
        {/* subtle glow */}
        <div
          aria-hidden="true"
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate text-sm font-semibold tracking-[-0.01em] text-heading">
              {userName}
            </p>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex h-7 w-7 items-center justify-center text-muted-foreground transition-colors duration-200 group-hover:text-destructive">
        ...
        <span className="font-mono text-[7px] uppercase tracking-[0.14em] text-muted-foreground/30 transition-colors group-hover:text-destructive/60">
          Exit
        </span>
      </button>
    </div>
