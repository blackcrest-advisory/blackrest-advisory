  ...
  return (
    <Section className="relative isolate overflow-hidden bg-background py-16 sm:py-20 lg:py-28">
      ...
      >
        ...
        <div className="absolute left-1/2 top-[46%] h-px w-[86%] -translate-x-1/2 bg-border/35"/>

        <div className="absolute right-[8%] top-[10%] h-80 w-80 rounded-full bg-secondary/[0.055] blur-[120px]"/>
      </div>
      ...
      <Container>
        ...
        <div className="grid min-w-0 gap-10 pt-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(500px,1.1fr)] lg:gap-14 lg:pt-14 xl:gap-20">
          {/*===== CONTENT =====*/}
                ...
                {outcomes.map((outcome, index) => (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-4">
                      ...
                      <span className="text-xs font-medium text-heading sm:text-sm">
                        {outcome}
                      </span>
                    </div>

                    <ArrowRight className="h-3.5 w-3.5 shrink-0 text-muted-foreground/30 transition-all duration-300 group-hover:translate-x-1 group-hover:text-secondary"/>
                  </div>
                ))}
              </div>
            </div>
          ...
          >
            ...
            {/* main frame */}
            <div className="relative min-h-[520px] overflow-hidden border border-border bg-primary shadow-[var(--shadow-overlay)] sm:min-h-[580px]">
              {/* image */}
              <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-navy-deep/40 via-navy-deep/65 to-navy-deep/95"/>

                <div className="absolute inset-0 bg-gradient-to-r from-navy-deep/70 via-transparent to-navy-deep/20"/>
              </div>
              ...
              <div className="absolute left-4 right-4 top-4 flex items-center justify-between gap-4 border-b border-white/15 pb-3 sm:left-6 sm:right-6 sm:top-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-[7px] font-semibold uppercase tracking-[0.16em] text-white/55">
                    Integrated signal
                  </span>
                </div>
              ...
              <div className="absolute inset-x-5 top-[22%] sm:inset-x-8">
                {/* center label */}
                <div className="mx-auto flex h-28 w-28 flex-col items-center justify-center rounded-full border border-gold-light/30 bg-navy-deep/70 text-center backdrop-blur-md sm:h-32 sm:w-32">
                  <motion.div
                    animate={
                      shouldReduceMotion
                        ? undefined
              ...
              <div className="absolute bottom-5 left-4 right-4 grid grid-cols-2 gap-px border border-white/10 bg-white/10 sm:bottom-6 sm:left-6 sm:right-6 lg:grid-cols-4">
                {channels.map((channel) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="absolute bottom-0 left-0 h-[2px] w-0 bg-gold-light transition-all duration-500 group-hover:w-full"/>
                    </div>
                  );
                })}
              </div>
