  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-0 opacity-[0.22] [background-image:linear-gradient(to_bottom,var(--color-border)_1px,transparent_1px)] [background-size:100%_72px] [mask-image:linear-gradient(to_right,transparent,black_12%,black_88%,transparent)]"
        />

        {/* gold ambient light */}
        <div
          className="absolute left-[8%] top-[18%] h-[340px] w-[340px] rounded-full bg-secondary/[0.055] blur-[130px]"
        />

        <div
          className="absolute -right-40 bottom-0 h-[380px] w-[380px] rounded-full bg-primary/[0.045] blur-[140px]"
        />
      </div>
      ...
      <Container>
        <div ref={ref}>
          ...
          >
            {/* board header */}
            <div
              className="flex flex-col gap-4 border-b border-border bg-muted/10 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6"
            >
              <div className="flex items-center gap-3">
                <span
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <p
                          className="mt-1 font-mono text-[7px] font-semibold uppercase tracking-[0.14em] text-muted-foreground/40"
                        >
                          {stat.eyebrow}
                        </p>
                      </div>
                      ...
                      <div
                        className="flex h-9 w-9 shrink-0 items-center justify-center border border-border bg-background text-secondary transition-all duration-300 group-hover:border-secondary/25 group-hover:bg-secondary/[0.045]"
                      >
                    ...
                    <div className="mt-10">
                      <div
                        className="whitespace-nowrap text-[44px] font-semibold leading-none tracking-[-0.06em] text-heading sm:text-[52px] xl:text-[48px] 2xl:text-[58px]"
                      >
                        {isInView ? (
                          <CountUp
                            start={0}
                      ...
                      <p
                        className="mt-4 max-w-[210px] text-xs font-medium leading-5 text-body"
                      >
                        {stat.label}
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <span
                        className="absolute bottom-0 left-0 font-mono text-[6px] font-semibold uppercase tracking-[0.14em] text-muted-foreground/25"
                      >
