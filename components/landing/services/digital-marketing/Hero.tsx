...
export default function Hero() {
  ...
  return (
    <Section className="relative isolate overflow-hidden bg-background pb-10 pt-8 sm:pb-12 sm:pt-10 lg:min-h-[calc(100svh-80px)] lg:pb-12 lg:pt-10">
      ...
      >
        {/* vertical grid */}
        <div className="absolute inset-0 opacity-[0.26] [background-image:linear-gradient(to_right,var(--color-border)_1px,transparent_1px)] [background-size:84px_100%] [mask-image:linear-gradient(to_bottom,black_10%,transparent_92%)]"/>

        {/* horizontal guide */}
        <div className="absolute left-0 right-0 top-[42%] h-px bg-border/50"/>

        {/* gold ambience */}
        <div className="absolute -left-32 top-16 h-96 w-96 rounded-full bg-secondary/[0.07] blur-[130px]"/>

        {/* navy ambience */}
        <div className="absolute -right-28 bottom-0 h-[420px] w-[420px] rounded-full bg-primary/[0.06] blur-[140px]"/>
      </div>

      <Container>
        <div className="grid min-w-0 items-center gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(440px,1.05fr)] lg:gap-10 xl:gap-16">
          {/*===== CONTENT =====*/}
          ...
          >
            ...
            >
              <span className="flex h-8 w-8 items-center justify-center border border-secondary/20 bg-secondary/[0.055] text-secondary">
          ...
          >
            ...
            <div className="relative aspect-[5/5.4] min-w-0 overflow-hidden border border-border bg-primary shadow-[var(--shadow-overlay)] sm:aspect-[5/4.5] lg:aspect-[5/5.1] xl:aspect-[5/4.7]">
              <motion.div
                whileHover={
                  shouldReduceMotion
                    ? undefined
              ...
              <div className="absolute bottom-0 left-0 right-0 border-t border-white/15 bg-navy-deep/80 px-4 py-4 backdrop-blur-xl sm:px-5 sm:py-5">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <TrendingUp className="h-4 w-4 shrink-0 text-gold-light"/>
                </div>
