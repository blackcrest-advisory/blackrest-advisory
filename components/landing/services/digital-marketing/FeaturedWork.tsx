...
export default function FeaturedWork() {
  ...
  return (
    <Section className="relative isolate overflow-hidden bg-background py-16 sm:py-20 lg:py-28">
      ...
      >
        <div className="absolute inset-0 opacity-[0.2] [background-image:linear-gradient(to_right,var(--color-border)_1px,transparent_1px)] [background-size:92px_100%] [mask-image:linear-gradient(to_bottom,transparent,black_18%,black_82%,transparent)]"/>

        <div className="absolute -left-40 top-[20%] h-[420px] w-[420px] rounded-full bg-secondary/[0.06] blur-[140px]"/>

        <div className="absolute -right-32 bottom-[5%] h-[380px] w-[380px] rounded-full bg-primary/[0.05] blur-[140px]"/>
      </div>
      ...
      <Container>
        ...
        <div className="mt-10 lg:mt-14">
          ...
          <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-3">
              <span className="font-mono text-[8px] font-semibold tracking-[0.16em] text-heading">
                {String(selectedIndex + 1).padStart(2, "0")}
              </span>

              <span className="h-px w-8 bg-border" />

              <span className="font-mono text-[8px] tracking-[0.16em] text-muted-foreground/35">
          ...
          <div className="relative min-w-0 overflow-hidden border border-border bg-primary shadow-[var(--shadow-overlay)]">
            {/* carousel viewport */}
            <div ref={emblaRef} className="overflow-hidden">
              <div className="flex">
                {projects.map((project, index) => (
                  ...
                  >
                    <article className="grid min-h-[640px] lg:grid-cols-[minmax(0,1.3fr)_minmax(370px,0.7fr)]">
                      {/*===== IMAGE STAGE =====*/}
                      ...
                      <div className="relative min-h-[430px] overflow-hidden lg:min-h-[640px]">
                        ...
                        <div className="absolute left-5 top-5 flex items-center gap-3 sm:left-6 sm:top-6">
                          <span className="flex h-8 w-8 items-center justify-center border border-white/15 bg-navy-deep/55 backdrop-blur">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 px-5 pb-6 sm:px-7 sm:pb-7 lg:px-8 lg:pb-8">
                          ...
                          <h3 className="mt-3 max-w-2xl text-2xl font-semibold leading-[1.05] tracking-[-0.04em] text-white sm:text-3xl lg:text-4xl">
                            {project.title}
                          </h3>
                        </div>
                      </div>
                      ...
                      <div className="relative flex min-w-0 flex-col border-t border-white/10 bg-navy-deep lg:border-l lg:border-t-0">
                        {/* top status */}
                        <div className="flex items-center justify-between gap-4 border-b border-white/10 px-5 py-4 sm:px-6">
                          ...
                          <span className="font-mono text-[7px] uppercase tracking-[0.14em] text-gold-light">
                            Active case
                          </span>
                        </div>

                        {/* description */}
                        <div className="flex-1 px-5 py-6 sm:px-6 lg:py-8">
                          ...
                          <div className="grid grid-cols-3 border-t border-white/10">
                            {project.metrics.map((metric, metricIndex) => (
                              ...
                              >
                                ...
                                >
                                  <span className="block text-xl font-semibold tracking-[-0.04em] text-gold-light sm:text-2xl">
                                    {metric.value}
                                  </span>
          ...
          <div className="mt-5 grid gap-4 border-b border-border pb-5 md:grid-cols-[auto_minmax(0,1fr)_auto] md:items-center">
            {/* arrows */}
            <div className="flex items-center gap-2">
              <button
                type="button"
