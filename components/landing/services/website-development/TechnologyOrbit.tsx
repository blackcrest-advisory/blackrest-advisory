              ...
              {!shouldReduceMotion && (
                <motion.div
                  ...
                  className="
                    ...
                    via-gold-light
                    to-transparent
                    shadow-[0_0_18px_rgba(232,207,143,0.32)]
                    sm:left-[41px]
                  "
                  animate={{
                    y: [0, 570, 0],
                ...
                >
                  ...
                  <div
                    className="
                      ...
                      bg-navy-deep
                      shadow-[0_0_40px_rgba(232,207,143,0.1)]
                    "
                  >
            ...
            {!shouldReduceMotion && (
              <motion.div
                ...
                className="
                  ...
                  via-gold-light
                  to-transparent
                  shadow-[0_0_14px_rgba(232,207,143,0.35)]
                  lg:block
                "
                initial={{
                  left: "-12%",
              ...
              >
                <TechIcon
                  className="
                      ...
                      transition-all
                      duration-300
                      group-hover/tech:text-gold-light
                    "
                />
