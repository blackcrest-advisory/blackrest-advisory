...
export default function PerformanceDashboard() {
  return (
    <Section className="relative isolate overflow-hidden bg-background py-16 sm:py-20 lg:py-28">
      ...
      >
        {/* architectural grid */}
        <div className="absolute inset-0 opacity-[0.16] [background-image:linear-gradient(to_right,var(--color-border)_1px,transparent_1px)] [background-size:96px_100%] [mask-image:linear-gradient(to_bottom,transparent,black_12%,black_88%,transparent)]"/>

        {/* restrained ambience */}
        <div className="absolute -right-40 top-[12%] h-[360px] w-[360px] rounded-full bg-secondary/[0.045] blur-[140px]"/>
      </div>

      <Container>
        {/*===== HEADER =====*/}

        <div className="grid gap-8 border-b border-border pb-10 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)] lg:items-end lg:gap-16 lg:pb-14">
          <div>
        ...
        <div className="mt-10 overflow-hidden border border-border bg-card shadow-[var(--shadow-card)] lg:mt-14">
          {/* board header */}
                ...
                >
                  ...
                  <div className="mt-8">
                    <div className="flex items-end gap-2">
                      <span className="text-5xl font-semibold leading-none tracking-[-0.055em] text-heading sm:text-6xl">
                        {metric.value}
                      </span>
                  ...
                  <div className="mt-7">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span className="font-mono text-[6px] font-semibold uppercase tracking-[0.13em] text-success">
                        Excellent
                      </span>
                    </div>

                    <div className="mt-2 h-[3px] overflow-hidden bg-muted">
                      <div
          ...
          <div className="grid border-t border-border lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
                ...
                >
                  <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-end gap-2 sm:text-right">
                      <span className="text-4xl font-semibold tracking-[-0.05em] text-heading">
                        {metric.value}
                      </span>
        ...
        <div className="mt-6 grid overflow-hidden border border-border bg-card md:grid-cols-[minmax(0,1fr)_auto] md:items-stretch">
          ...
          <div className="flex items-center border-t border-border bg-primary px-5 py-5 text-white md:border-l md:border-t-0 sm:px-6">
            <div>
              ...
              <p className="mt-2 max-w-[260px] text-xs leading-5 text-white/42">
