...
export default function WebsiteAnatomy() {
  ...
  return (
    <Section className="relative isolate overflow-hidden bg-background py-16 sm:py-20 lg:py-28">
      ...
      >
        {/* blueprint grid */}
        <div className="absolute inset-0 opacity-[0.22] [background-image:linear-gradient(to_right,var(--color-border)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-border)_1px,transparent_1px)] [background-size:72px_72px] [mask-image:linear-gradient(to_bottom,transparent,black_12%,black_88%,transparent)]"/>

        {/* ambient gold glow */}
        <div className="absolute left-[15%] top-[16%] h-[360px] w-[360px] rounded-full bg-secondary/[0.055] blur-[130px]"/>

        {/* ambient navy glow */}
        <div className="absolute -right-40 bottom-[5%] h-[420px] w-[420px] rounded-full bg-primary/[0.04] blur-[150px]"/>

        {/* architectural rails */}
        <div className="absolute left-[7%] top-0 h-full w-px bg-border/35"/>

        <div className="absolute right-[7%] top-0 h-full w-px bg-border/35"/>
      </div>
      ...
      <Container>
        ...
        <div className="mt-10 grid min-w-0 gap-6 lg:mt-14 xl:grid-cols-[minmax(0,1fr)_290px]">
          {/*===== SYSTEM MAP =====*/}
          ...
          >
            ...
            <div className="flex flex-col gap-3 border-b border-border bg-muted/10 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
              <div className="flex items-center gap-3">
            ...
            <div className="relative hidden min-h-[720px] overflow-hidden md:block">
              ...
              >
                <div className="relative flex h-44 w-44 flex-col items-center justify-center rounded-full border border-secondary/30 bg-background/90 text-center shadow-[0_0_70px_rgba(166,124,39,0.1)] backdrop-blur-xl">
                  {!shouldReduceMotion && (
                    <motion.div
                      aria-hidden="true"
                  ...
                  <div className="flex h-10 w-10 items-center justify-center border border-secondary/20 bg-secondary/[0.05] text-secondary">
                    <Cpu className="h-4 w-4" />
                  </div>

                  <span className="mt-3 font-mono text-[7px] font-semibold uppercase tracking-[0.16em] text-secondary">
                    Blackcrest
                  </span>
                  ...
                  <span className="mt-2 font-mono text-[6px] uppercase tracking-[0.13em] text-muted-foreground/35">
              ...
              {nodes.map((node, index) => {
                ...
                return (
                  <motion.article
                    ...
                    `}
                  >
                    <div className="relative overflow-hidden border border-border bg-card/95 px-4 py-3.5 shadow-[var(--shadow-card)] backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-secondary/30">
                      <span
                        aria-hidden="true"
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex h-8 w-8 shrink-0 items-center justify-center border border-secondary/15 bg-secondary/[0.045] text-secondary">
                      ...
                      <h4 className="mt-3 text-xs font-semibold text-heading">
                        {node.label}
                      </h4>
              ...
              <span className="absolute bottom-4 left-5 font-mono text-[6px] uppercase tracking-[0.15em] text-muted-foreground/25">
                X: 08 / Y: 24 / Architecture
              </span>

              <span className="absolute bottom-4 right-5 font-mono text-[6px] uppercase tracking-[0.15em] text-muted-foreground/25">
                Topology / 08 Nodes
              </span>
            </div>
            ...
            <div className="grid md:hidden">
              <div className="border-b border-border bg-secondary/[0.025] px-5 py-6 text-center">
                <div className="mx-auto flex h-10 w-10 items-center justify-center border border-secondary/20 bg-secondary/[0.05] text-secondary">
                  <Cpu className="h-4 w-4" />
                </div>

                <span className="mt-3 block font-mono text-[7px] font-semibold uppercase tracking-[0.16em] text-secondary">
                  Core System
                </span>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center border border-secondary/15 bg-secondary/[0.045] text-secondary">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center justify-between gap-3">
                            ...
                            <span className="font-mono text-[7px] text-secondary/45">
                              {node.number}
                            </span>
                          </div>
          ...
          >
              ...
              {systemHealth.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="font-mono text-[7px] font-semibold uppercase tracking-[0.12em] text-success">
                      {item.value}
                    </span>
                  </div>
                );
            ...
            {/* footer */}
            <div className="border-t border-white/10 bg-navy-deep/40 px-5 py-4">
