  ...
  return (
    <Section className="relative isolate overflow-hidden bg-background py-0">
      ...
      >
        ...
        <div className="absolute left-[7%] top-0 h-full w-px bg-border/45"/>

        <div className="absolute right-[7%] top-0 h-full w-px bg-border/45"/>

        {/* subtle dot texture */}
        <div className="absolute inset-0 opacity-[0.16] [background-image:radial-gradient(var(--color-border)_0.8px,transparent_0.8px)] [background-size:24px_24px] [mask-image:linear-gradient(to_bottom,transparent,black_12%,black_88%,transparent)]"/>

        {/* restrained glow */}
        <div className="absolute -right-28 top-[12%] h-[440px] w-[440px] rounded-full bg-secondary/[0.06] blur-[150px]"/>

        <div className="absolute -left-32 bottom-[5%] h-[380px] w-[380px] rounded-full bg-primary/[0.045] blur-[150px]"/>
      </div>
      ...
      <Container>
        ...
        <div className="grid min-w-0 border-x border-border lg:min-h-[720px] lg:grid-cols-[minmax(0,0.9fr)_minmax(500px,1.1fr)]">
          {/*===== LEFT CONTENT =====*/}
          ...
          >
            ...
            <div className="mt-7 grid max-w-lg grid-cols-2 gap-x-5 gap-y-3">
          ...
          >
            ...
            <div className="relative mx-auto h-full min-h-[570px] max-w-[650px] border border-border bg-background/60 backdrop-blur-sm">
              {/*===== FRAME HEADER =====*/}

              <div className="flex items-center justify-between gap-4 border-b border-border bg-background/70 px-4 py-3 sm:px-5">
                <div className="flex items-center gap-3">
              ...
              <div className="relative flex min-h-[510px] items-center justify-center overflow-hidden px-4 py-12">
                {/* feature modules */}
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <span className="block text-[10px] font-semibold text-heading">
                            {feature.label}
                          </span>
                ...
                <div className="relative z-10 flex items-center justify-center">
                  ...
                  {/* device frame */}
                  <div className="relative overflow-hidden rounded-[32px] border-[5px] border-primary bg-primary p-[3px] shadow-[0_28px_70px_rgba(10,22,40,0.24)]">
                    ...
                    {/* speaker */}
                    <div className="absolute left-1/2 top-2 z-20 h-1.5 w-12 -translate-x-1/2 rounded-full bg-primary"/>
                  </div>
                  ...
                  >
                    <span className="block h-1 w-12 rounded-full bg-secondary/60"/>
                  </motion.div>
                </div>

                {/*===== MOBILE FEATURES =====*/}

                <div className="absolute bottom-5 left-4 right-4 z-20 grid grid-cols-3 gap-2 sm:hidden">
...
function MobileFeature({
  ...
  return (
    <div className="border border-border bg-card/95 px-2 py-2.5 text-center backdrop-blur">
      <Icon className="mx-auto h-3.5 w-3.5 text-secondary"/>

      <span className="mt-1.5 block text-[9px] font-medium text-heading">
        {label}
      </span>
    </div>
  );
