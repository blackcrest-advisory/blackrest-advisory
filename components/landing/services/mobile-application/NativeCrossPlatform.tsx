      ...
      <Container>
        ...
        >
          ...
          >
            ...
            <div
              className="mt-6 flex h-12 w-12 items-center justify-center border border-secondary/20 bg-secondary/[0.045] text-secondary"
            >
              <Code2 className="h-5 w-5" />
            </div>

            <h3
              className="mt-6 text-2xl font-semibold tracking-[-0.03em] text-heading"
            >
              Build once.
            ...
            {/* simple feature list */}
            <div
              className="mt-7 space-y-3 border-t border-border pt-5"
            >
              {[
          ...
          >
            ...
            >
              {/* central node */}
              <div
                className="border border-secondary/25 bg-primary px-5 py-5 text-center text-white"
              >
                <Code2
                  className="mx-auto h-5 w-5 text-gold-light"
                />

                <span
                  className="mt-3 block font-mono text-[7px] font-semibold uppercase tracking-[0.14em] text-gold-light"
                >
                  Shared Codebase
                </span>
              ...
              <div className="grid grid-cols-2 gap-3">
                {platforms.map((platform) => (
                  ...
                  >
                    ...
                    <span
                      className="mt-2 block text-sm font-semibold text-heading"
                    >
                      {platform.label}
                    </span>

                    <span
                      className="mt-1 block font-mono text-[6px] uppercase tracking-[0.11em] text-muted-foreground/35"
                    >
                      {platform.detail}
                    </span>
                  </div>
            ...
            <p
              className="mt-6 text-center font-mono text-[7px] font-semibold uppercase tracking-[0.14em] text-muted-foreground/35"
            >
          ...
          >
            ...
            <h3
              className="mt-3 text-xl font-semibold tracking-[-0.025em] text-heading"
            >
              Less duplication.
        ...
        >
          <p
            className="max-w-xl text-sm font-medium leading-6 text-heading"
          >
