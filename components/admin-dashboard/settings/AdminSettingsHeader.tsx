    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-secondary/20 bg-secondary/[0.06] text-secondary"
            >
...
function SecurityMeta({ label, value }: { label: string; value: string }) {
  return (
    <div className="px-3 first:pl-0 last:pr-0">
      ...
      <p
        className="mt-1 text-[11px] font-semibold text-heading"
      >
        {value}
      </p>
    </div>
