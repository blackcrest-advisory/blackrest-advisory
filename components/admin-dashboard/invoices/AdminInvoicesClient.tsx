            ...
            <div className="divide-y divide-border lg:hidden">
              {visibleInvoices.map((invoice) => (
                ...
                >
                  ...
                  {/* amount */}
                  <div className="mt-4 flex items-center justify-between gap-4 border border-border bg-background/30 px-3 py-3">
                    <div>
                      <span className="font-mono text-[7px] font-semibold uppercase tracking-[0.14em] text-muted-foreground/40">
                        Invoice value
                      </span>

                      <p className="mt-1 text-base font-semibold tracking-[-0.02em] text-heading">
                        {formatMoney(invoice.amount, invoice.currency)}
                      </p>
                    </div>
