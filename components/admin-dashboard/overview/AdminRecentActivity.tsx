              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    {/* timeline icon */}
                    <div className="relative z-10 flex h-9 w-9 shrink-0 items-center justify-center border border-border bg-background text-secondary transition-all duration-200 group-hover:border-secondary/30 group-hover:bg-secondary group-hover:text-secondary-foreground">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        ...
                        <span className="shrink-0 font-mono text-[8px] uppercase tracking-[0.12em] text-muted-foreground/45">
                          {activity.timestamp}
                        </span>
                      </div>
                      ...
                      <div className="mt-3 flex items-center gap-2">
                        ...
                        <span className="font-mono text-[7px] text-muted-foreground/25">
                          /
                        </span>
