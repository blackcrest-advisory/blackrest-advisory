...
export const Textarea = ({
  ...
  return (
    <div className="relative w-full">
      ...
      <textarea
        className={cn(
          "w-full rounded-[var(--radius-control)] border border-border bg-background px-3 py-2.5 text-sm leading-6 text-foreground shadow-[inset_0_1px_1px_rgb(15_23_42/0.02)] transition-[border-color,box-shadow,background-color] duration-200 placeholder:text-muted-foreground/70",
